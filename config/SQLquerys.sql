...
INSERT INTO Projekte (
    Erstellt_von, Erstellt_am, Geändert_am, Beschreibung, Variable_Projektnr, 
    HiliteSortiertNach, Projektname, Eins, ProjektID, Status, Typ, Beginn, 
    Fälligkeit, lfdNr, Projektkürzel, Projektsumme_1, Verantwortlicher, KontaktID, 
    Fremdleistungen, Netto_Stundenkontigent, Summe_Stunden, Abschlag_percent, 
    ...
    Übrige_Stunden_ist, Wert_Planung, Wert_Verfahren, vProjektID, vKontaktID, 
    Projektwert_Summe, Netto_Projektwert_Summe, Summe_Fremdleistungen, 
    Stundenvorgaben_Summe, Übrige_Stunden_Summe, RestProjektwert_Netto_über_Stunden, 
    vProjektkürzel, Angebot_Erstellt_am, Angebot_Erstellt_von, Angebot_Beauftragungsdatum, 
    Projektfarbe, Wert_Grün, Wert_Verfahren_Sonstiges, Projekt_Restwert, Teammitglieder, 
    Leistungsstand_Projekt, Team, vMitarbeiterteam, vAktiv, Angebotssumme, 
    Fremdleistungen_Details, ProjektwertDetails, Übrige_Stunden_soll, 
    Leistungsstand_Restwert_Projekt, vRechnungsnummer, Reststunden_netto, Monat, 
    Stundendatum, Reststunden_Prozent, ProjektFarbeID, Summe_Projektrestwert, 
    Summe_Übrige_Stunden_Soll, Summe_Übrige_Stunden_ist, Reststunden, leerfeld, 
    Reststunden_Kopie, Ampelwert, Leistungsstand_Projekt_ist
)
VALUES

('Ana Sánchez', '2024-04-21', '2024-04-21', 'Desarrollo de una nueva plataforma web', 'PRJ001', 
 'Prioridad Alta', 'Plataforma Web', 1.00, 'ID006', 'Activo', 'Desarrollo', '2024-05-01', 
 '2024-12-31', '001', 'PW', 10000.00, 'Carlos Ruiz', 'KID001', 
 10, '100 horas', '90 horas', 10, 
 1000.00, 200.00, 5000, 8000, 
 ...
 90.00, 5000, 8000, 'VPID001', 'VKID001', 
 15000.00, 7000.00, 5000.00, 
 200.00, 90.00, 7000.00, 
 'PW', '2024-04-21', 'Creador Oferta A', '2024-04-22', 
 0x01, 5000, 8000, 3000.00, 'Equipo A', 
 95.00, 'Equipo Proyecto A', 'Equipo Material A', 'Activo', 10000.00, 
 'Detalles de las fremdleistungen A', 'Detalles del valor del proyecto A', 90.00, 
 3000.00, 'RNUM001', 10.00, 'Abril', 
 '2024-04-21', 10.00, 1.00, 3000.00, 
 90.00, 90.00, 10.00, '', 
 10.00, 1.00, 95.00),

('Luis Méndez', '2024-04-22', '2024-04-22', 'Renovación de infraestructura IT', 'PRJ002', 
 'Urgencia Media', 'IT Renovación', 1.00, 'ID007', 'Pendiente', 'Infraestructura', '2024-06-01', 
 '2024-11-30', '002', 'ITR', 15000.00, 'María López', 'KID002', 
 15, '150 horas', '140 horas', 15, 
 2250.00, 300.00, 7500, 12000, 
 ...
 140.00, 7500, 12000, 'VPID002', 'VKID002', 
 22500.00, 10500.00, 7500.00, 
 300.00, 140.00, 10500.00, 
 'ITR', '2024-04-22', 'Creador Oferta B', '2024-04-23', 
 0x01, 7500, 12000, 4500.00, 'Equipo B', 
 98.00, 'Equipo Proyecto B', 'Equipo Material B', 'Inactivo', 15000.00, 
 'Detalles de las fremdleistungen B', 'Detalles del valor del proyecto B', 140.00, 
 4500.00, 'RNUM002', 15.00, 'Mayo', 
 '2024-05-01', 15.00, 2.00, 4500.00, 
 140.00, 140.00, 15.00, '', 
 15.00, 2.00, 98.00),


('Ana Sánchez', '2024-04-21', '2024-04-21', 'Desarrollo de una nueva plataforma web', 'PRJ001', 
 'Prioridad Alta', 'Plataforma Web', 1.00, 'ID001', 'Activo', 'Desarrollo', '2024-05-01', 
 '2024-12-31', '001', 'PW', 10000.00, 'Carlos Ruiz', 'KID001', 
 10, '100 horas', '90 horas', 10, 
 1000.00, 200.00, 5000, 8000, 
 7000.00, 'Tarea A', 'En curso', 'ProyA', 'Creador A', 
...
('Luis Méndez', '2024-04-22', '2024-04-22', 'Renovación de infraestructura IT', 'PRJ002', 
 'Urgencia Media', 'IT Renovación', 1.00, 'ID002', 'Pendiente', 'Infraestructura', '2024-06-01', 
 '2024-11-30', '002', 'ITR', 15000.00, 'María López', 'KID002', 
 15, '150 horas', '140 horas', 15, 
 2250.00, 300.00, 7500, 12000, 
 10500.00, 'Tarea B', 'Pausado', 'ProyB', 'Creador B', 
...
('Ana Sánchez', '2024-04-21', '2024-04-21', 'Desarrollo de una nueva plataforma web', 'PRJ001', 
 'Prioridad Alta', 'Plataforma Web', 1.00, 'ID003', 'Activo', 'Desarrollo', '2024-05-01', 
 '2024-12-31', '001', 'PW', 10000.00, 'Carlos Ruiz', 'KID001', 
 10, '100 horas', '90 horas', 10, 
 1000.00, 200.00, 5000, 8000, 
 7000.00, 'Tarea A', 'En curso', 'ProyA', 'Creador A', 
 ...
 10.00, 1.00, 95.00),
('Ana Sánchez', '2024-04-21', '2024-04-21', 'Desarrollo de una nueva plataforma web', 'PRJ001', 
 'Prioridad Alta', 'Plataforma Web', 1.00, 'ID004', 'Activo', 'Desarrollo', '2024-05-01', 
 '2024-12-31', '001', 'PW', 10000.00, 'Carlos Ruiz', 'KID001', 
 10, '100 horas', '90 horas', 10, 
 1000.00, 200.00, 5000, 8000, 
 7000.00, 'Tarea A', 'En curso', 'ProyA', 'Creador A', 
...
('Roberto', '2024-04-21', '2024-04-21', 'Desarrollo de una nueva plataforma web', 'PRJ001', 
 'Prioridad Alta', 'Plataforma Web', 1.00, 'ID005', 'Activo', 'Desarrollo', '2024-05-01', 
 '2024-12-31', '001', 'PW', 10000.00, 'Carlos Ruiz', 'KID001', 
 10, '100 horas', '90 horas', 10, 
 1000.00, 200.00, 5000, 8000, 
 7000.00, 'Tarea A', 'En curso', 'ProyA', 'Creador A', 
