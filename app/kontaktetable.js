...
//////////COLUMNA 2///////////////
   ...
   ///////////SEARCH///////////////
    ...
    searchInput.id = 'searchKontakteInput';
...
var a3 = document.createElement("a");
  ...
  a3.setAttribute("id", "editKontakteButton");
...
function updateKontakteModalFields(data) {
  ...
  function addModalKontakteFields() {
    document.getElementById("dialogKontakteTitle").textContent = "Add Kontakte";
    document.getElementById("kontakteId").textContent = "";
    document.getElementById("kontakteAnrede").value =  "";
    document.getElementById("kontakteVorname").value ="";
    document.getElementById("kontakteNachname").value = "";
    document.getElementById("kontakteTelefon" ).value ="";
    document.getElementById("kontakteMobil").value ="";
    document.getElementById("kontakteEmail").value ="";
    document.getElementById("kontakteWebadress").value ="";
    document.getElementById("kontakteAbteilung").value ="";
    document.getElementById("kontakteTyp").value = "";
    document.getElementById("submitKontakteButton").onclick = addKontakte;
